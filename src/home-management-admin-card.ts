...
export class HomeManagementAdminCard extends LitElement {
  ...
  static styles = [tokens, css`
    ...
    .item { cursor:grab; } .item:active { cursor:grabbing; } .item.dragging { opacity:0.5; } .drag-handle { color:var(--ink-faint); font-size:12px; margin-right:6px; flex-shrink:0; }
